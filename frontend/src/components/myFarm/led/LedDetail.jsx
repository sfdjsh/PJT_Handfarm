...
import { Typography, Box, Card, Button, InputAdornment, OutlinedInput, CardContent } from "@mui/material";
    ...
    <>
      <Card sx={{ mt: 2, backgroundColor: "#1E1E1E" }}>
        <CardContent>
          ...
          <Box sx={{ mt: 3 }}>
          <Typography variant="h7" color="white">시간 설정</Typography>
            <Box display="flex" alignItems="center" sx={{mt:1}}>
              ...
              size='large'
              endAdornment={<InputAdornment fontWeight='bold'>시</InputAdornment>}
              sx={{ background: 'white', width: '8ch', fontWeight: 'bold' }}
              onChange={(e) => setStartLed(e.target.value)}
              />
              <span style={{fontSize:'20px', margin:'5px', color:'white'}}> ~ </span>
          ...
          <Box sx={
            ...
            <Button variant="contained"
              ...
              onClick={() => sensorManual({ deviceId, startLed, endLed, controlName })}
            >
              <h3>등록</h3>
            </Button>
          </Box>
