...
export const ChatList = () => {
    ...
    return(
        <>
            <Box>
                <Typography sx={{ fontWeight : "bold", mt : 5, textAlign : "center" }} variant="h4" component="h3">Farm Talk</Typography>
                <Divider sx={{ mt : 2, mb:3, backgroundColor : "#757575" }}/>
            </Box>
            <Box>
                {chatList.map((chat, index) => (
                    <Box  className="myChatList">
                        <Grid container>
                            ...
                            <Grid item xs={8} >
                                <Grid container>
                                    ...
                                    <p style={{ textAlign : "left", lineHeight : "25px", color : "white", margin : "0px" , marginTop : "20px", textOverflow : "ellipsis", overflow : "hidden", whiteSpace : "nowrap" }}>
                                        {chat.content}
                                    </p>
